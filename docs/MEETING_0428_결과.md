...
| 순위 | 항목 | 기한 |
|------|------|------|
| 🔴 P0 | 사용자 질문 응답 기능 구현 | 내일까지 |
| 🔴 P0 | 경고 피로 후처리 — 보팅 방식 적용 | 내일까지 |
| 🔴 P1 | deque 싱크 버그 수정 | 이번 주 |
| 🔴 P1 | 바운딩 박스 비트 불일치 확인 | 이번 주 |
| 🟡 P2 | 서버 데이터 송수신 테스트 | 이번 주 |
| 🟡 P2 | 외부 DB 조사 (LTE 테스트용) | 이번 주 |
| 🟡 P3 | 대시보드 지도 UI + 네비게이션 API 조사 | 다음 주 |
| 🟢 보류 | 사물 클래스 추가 | 기능 완성 후 |
| 🟢 보류 | 뎁스 카메라 거리 측정 | 보류 |
