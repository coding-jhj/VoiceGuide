...
| 경고 계층 분리 ⭐ | 위험도 낮은 알림은 비프음으로만 | (음성 대신 짧은 비프음) |
...
|------|------|------|------|------|
| 4/27 (월) | 서버 end-to-end 동작 확인 | 테스트 이미지 수집 시작 | STT 소음 환경 테스트 | PPT 초안 작성 |
