TEMPLATES = {
    ...
    # 사람 전용
    ("left",   "가까이"): "사람이 왼쪽 가까이에 있어요. 천천히 이동하세요.",
    ("center", "가까이"): "사람이 바로 앞에 있어요. 멈추세요.",
    ("right",  "가까이"): "사람이 오른쪽 가까이에 있어요. 천천히 이동하세요.",

    # 추가 방향별 상세 템플릿 (30~50개 확장용)
    # 아래는 class별로 다른 표현을 쓰고 싶을 때 sentence.py에서 분기 처리
}
